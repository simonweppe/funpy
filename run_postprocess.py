...
savedir = os.path.join('/data2', 'enuss', 'funwave_lab_setup', rundir, 'postprocessing', 'compiled_output_test')
if not os.path.exists(savedir):
	os.makedirs(savedir)

if not os.path.exists(os.path.join(fdir, 'compiled_output_test', 'dep.out')):
